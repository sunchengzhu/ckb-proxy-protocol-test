...
echo ""
echo "[0/2] 清理残留进程 ..."
for PID_FILE in "${BASE_DIR}/.node_a_pid" "${BASE_DIR}/.node_c_pid"; do
    if [ -f "${PID_FILE}" ]; then
...
echo "=========================================="
echo ""
echo "  节点 A (TCP): PID=${NODE_A_PID}  RPC=127.0.0.1:8124"
